...
{
	remove_post_type_support('abb-testimonial', 'title');
	remove_post_type_support('abb-testimonial', 'editor');

	remove_post_type_support('abb-founder', 'title');
	remove_post_type_support('abb-founder', 'editor');

	remove_post_type_support('abb-location', 'title');
	remove_post_type_support('abb-location', 'editor');

	remove_post_type_support('abb-cta-article', 'title');
