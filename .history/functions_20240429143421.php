...
function disable_title_and_editor()
{
	...
	remove_post_type_support('abb-cta-article', 'editor');
}
...
// remove number of results found on shop pageb and drop down sorting
...
{
	// $fireIcon = "http://localhost/big-boy-burgers/wp-content/uploads/2024/04/c2ce29ffa5e9bed13b899af8e519f551.png";
	// return '<img src="'.esc_url($fireIcon).'" alt="Related products icon" aria-hidden="true">Suggested Items';
...
{
	global $product;
	echo '<a class="button btn-primary w-full" href="' . esc_url($product->add_to_cart_url()) . '">Add to Cart</a>';
}
